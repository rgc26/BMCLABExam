...
class _________________ extends StatefulWidget {
...
class ___________________ extends State<ExampleStaggeredAnimations>
  ...
  ______ AnimationController _drawerSlideController;
  ...
  void ________() {
    ...
    _drawerSlideController = AnimationController(
      ...
      duration: const Duration(milliseconds: _______),
    );
  }
...
void dispose() {
  ...
  _drawerSlideController._______();
...
bool _isDrawerOpening() {
  ...
  return _drawerSlideController._______ == AnimationStatus.forward;
}
...
bool _isDrawerClosed() {
  ...
  return _drawerSlideController.value == ______________;
}
...
void _____________() {
  ...
  _staggeredController = _______________(
...
Widget _buildContent() {
  ...
  return ________(
    ...
    ___________: [
      ...
      const SizedBox(height: ________),
    ...
    child: Padding(
      ...
      child: _____________(
        ...
        builder: (context, child) {
          ...
          final opacity = animationPercent.clamp(______, ___________);
